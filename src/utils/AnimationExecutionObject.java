...
public class AnimationExecutionObject {
	...
	private NumbersPair targetCoordinates = null, animationStep = null;

	public AnimationExecutionObject(ImageView imageView) {
		this.imageView = imageView;
	}

	public void setAnimationCredentials(NumbersPair animationTargetCoordinates) {

		this.targetCoordinates = animationTargetCoordinates;

		// calculating animation steps

		this.animationStep = new NumbersPair(Credentials.INSTANCE.animationStep, Credentials.INSTANCE.animationStep);
